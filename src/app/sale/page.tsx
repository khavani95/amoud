    ...
    <div className="flex flex-col min-h-screen font-vazirmatn">
      ...
      <main className="flex-grow pt-20 bg-gradient-to-b from-gray-50 to-gray-100">
        ...
        >
          ...
          جهت کسب اطلاعات بشتر و اطلاع از شرایط فروش با شماره های زیر تماس حاصل فرمایید
             </p>    <p className="text-lg font-bold text-gray-500 text-center mb-2">
            مهندس خوانی  : <a href="tel:+989123505524">09123505524</a>
          </p>
               <p className="text-lg font-bold text-gray-500 text-center mb-12">
            مهندس مومن : <a href="tel:+989125458578">09125458578</a>
          </p>
